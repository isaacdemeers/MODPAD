...
const DEFAULT_CONFIG = {
    settings: {
        game: {
            resWidth: ModPadConfig.settings.game.width,
            resHeight: ModPadConfig.settings.game.height,
            fullscreen: ModPadConfig.settings.game.fullscreen,
            autoConnect: ModPadConfig.settings.game.autoConnect,
            launchDetached: ModPadConfig.settings.game.launchDetached
        },
        launcher: {
            allowPrerelease: ModPadConfig.settings.launcher.allowPrerelease,
            dataDirectory: ModPadConfig.settings.launcher.dataDirectory || dataPath
        }
    },
    newsCache: {
        date: null,
    ...
    clientToken: null,
    selectedServer: ModPadConfig.distribution.mainServer, // Resolved
